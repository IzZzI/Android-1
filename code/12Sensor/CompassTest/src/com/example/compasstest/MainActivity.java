...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Sensor magneticsSensor = sensorManager.getDefaultSensor
				(Sensor.TYPE_MAGNETIC_FIELD);
		sensorManager.registerListener
			(listener, magneticsSensor, SensorManager.SENSOR_DELAY_GAME);
		sensorManager.registerListener
			(listener, accelerometerSensor, sensorManager.SENSOR_DELAY_GAME);
	}
	...
	private SensorEventListener listener = new SensorEventListener() {
		...
		public void onSensorChanged(SensorEvent event) {
			...
			SensorManager.getRotationMatrix
				(R, null, accelerometerValues, magneticValues);
